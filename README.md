...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6045096a75545000154b7ab0
...
To start editing your site, you can use the Sanity interface at https://blue-spider-5096a.sanity.studio/.
...
Generated at `2021-03-07T17:13:43.552Z` by Stackbit version `0.3.50`.